...
patient_identifier = "centralized"
...
joblib.dump(clf, "saved_model_knn_"+patient_identifier+".pkl")

with open(f"results_acc_knn.json", 'w') as f:
	json.dump(accuracies_dict, f)

with open(f"results_auc_knn_.json".replace(' ','-'), 'w') as f:
