...
for patient, patient_identifier in zip(csvs,["old-008", "old-001", "old-009", "old-011", "old-014", "005", "006", "007", "008", "009", "010", "011", "001b", 
	...
	y_processed_labels = np.array(y_processed_labels)[:,0]
	...
	joblib.dump(clf, "saved_model_knn_left_"+patient_identifier+".pkl")

with open(f"results_acc_knn_left.json", 'w') as f:
